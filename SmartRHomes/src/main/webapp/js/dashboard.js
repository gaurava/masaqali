...
$(function() {
	sendJSONAjaxRequest(true, "service/data/meterIds?p=watermeter", "", fnPopulateMeterId, null);
	sendJSONAjaxRequest(true, "service/data/nucliousIds", "", fnPopulateNucliousId, null);
	$('#GetMeterData').click(function(){
		fnReCreateMeterTable();
		sendJSONAjaxRequest(true, "service/data/meterIdData?p=watermeter&mid="+mid+"&date="+mDate, "", fnPopulateMeterIdData, null);
	});
...
//		fnReCreateNWMDTable();
		sendJSONAjaxRequest(true, "service/data/NWMDData?nid="+nid+"&date="+nDate, "", fnPopulateNucliousMeterWideData, null);
	});
